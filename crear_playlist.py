...
EPG_LIST = open('listasepg.txt',"r") # for a clean code 
...
def main():
    ...
    with open("tvlibre.m3u8", "w", encoding='utf-8') as playlist:
        ...
        for filename in sorted(os.listdir(".")):
            ...
            with open(filename, encoding='utf-8') as markup_file:
                file_country = os.path.join("..", dir_playlists, "tv_" + filename[:-3:] + ".m3u8")
